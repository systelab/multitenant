package com.werfen.laboratory.architecture;
...
@AnalyzeClasses(packages = "com.werfen.laboratory", importOptions = ImportOption.DoNotIncludeTests.class)
public class ControllerTest {
    ...
    static ArchRule allFilesInPackageControllerShouldBeControllersOrDtos = classes()
        ...
        .orShould().haveSimpleNameEndingWith("Mapper").orShould().haveSimpleNameEndingWith("MapperImpl")
